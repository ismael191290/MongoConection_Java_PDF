...
public class HttpUrl {
    ...
    String idValor = "";
    public static String IP_LOGIN = "http://api-twitter.us-east-1.elasticbeanstalk.com/mexa/lista";

    public HttpUrl(JSONObject json) {
        this.jsono=json;
    }

    public String getData() {
        try {
            idValor = "" + urlConnections();
    ...
    public String urlConnections() throws JSONException {
        int respuesta = 0;
        String regresoid = "";
    ...
    public String inputStreamToString(InputStream is) throws IOException {
        ...
        datoSend("Recibido " + repuesta);
        return repuesta;
    }

    public void datoSend(String mensajes) throws IOException {
        String ruta = "RUTa SendMEXA.txt";
